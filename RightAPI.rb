...
attr_accessor :api_call, :api_version, :log, :debug, :api_url, :log_file, :puts_exceptions, :reraise_exceptions
	...
	def	send(apistring,type = "get", params = {})
		...
		@resid = @apiheader[:location].match(/\d+$/) if @apiheader[:status].downcase.match(/201/)
		#pp @apiheader[:status].downcase.match(/201/)
